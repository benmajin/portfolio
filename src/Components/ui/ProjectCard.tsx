...
const ProjectCard = ({
	...
	<div className="group relative max-h-96 overflow-hidden">
		...
		<div className="absolute bottom-0  w-full transform overflow-hidden bg-black/90 text-mainWhite transition-all delay-500 duration-500 md:translate-y-2/3 md:bg-black/60 md:group-hover:-translate-y-0 md:group-hover:bg-black/90">
			...
			<div className="px-4 transition-all delay-1000 duration-300 md:opacity-0 md:group-hover:opacity-100">
				...
				<div className="flex space-x-3 py-4">
					{githubLink && <ButtonProjects destination={githubLink} label="Github" />}
